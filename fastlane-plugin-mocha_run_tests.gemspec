...
require 'fastlane/plugin/mocha_run_tests/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-mocha_run_tests'
  spec.version       = Fastlane::MochaRunTests::VERSION
  spec.author        = 'Adam T Armstrong'
